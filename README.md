...
Então sujiro que faça o mesmo: Abre o X11/symbols, abre um dos arquivos como BR, PT, US, RU etc e copie o layout abaixo.
...
USO:
EU IMPLORO QUE ALGUÉM FAÇA DISSO UM LAYOUT BAIXÁVEL E APERFEIÇOE AS FUNÇÕES / TECLAS.
